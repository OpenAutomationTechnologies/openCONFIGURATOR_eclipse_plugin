...
/**
 * <p>Java class for ProfileBody_CommunicationNetwork_Powerlink_Modular_Head complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProfileBody_CommunicationNetwork_Powerlink_Modular_Head"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.ethernet-powerlink.org}ProfileBody_DataType"&gt;
 *       &lt;choice&gt;
 *         &lt;group ref="{http://www.ethernet-powerlink.org}g_ProfileBody_CommunicationNetwork_Powerlink_Modular_Head"/&gt;
...
@XmlType(name = "ProfileBody_CommunicationNetwork_Powerlink_Modular_Head", propOrder = {
    "applicationLayers",
    "transportLayers",
    "networkManagement",
    "externalProfileHandle"
})
public class ProfileBodyCommunicationNetworkPowerlinkModularHead
    extends ProfileBodyDataType
{

    @XmlElement(name = "ApplicationLayers")
    protected TApplicationLayersModularHead applicationLayers;
     ...
     * @return
     *     possible object is
     *     {@link TApplicationLayersModularHead }
     *     
     */
    public TApplicationLayersModularHead getApplicationLayers() {
     ...
     *     
     */
    public void setApplicationLayers(TApplicationLayersModularHead value) {
